...
// .then( () => {
//   jeff.setCampus(phobos);
//   jason.setCampus(europa);
// })
...
module.exports = app
  ...
  .use(bodyParser.json())
  .use('/bootstrap', express.static(path.join(__dirname, '../node_modules/bootstrap/dist/css/bootstrap.css')))
  .use('/default-campus.jpg', express.static(path.join(__dirname, '../public/default-campus.jpg')))
